      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ms-auto">
            <a class="nav-link text-light fw-bolder" href="index.php?p=home">Home</a>
            <a class="nav-link text-light fw-bolder" href="index.php?p=officespace">Office Space</a>
            <a class="nav-link text-light fw-bolder" href="index.php?p=coworking">Co-Working</a>
            <a class="nav-link text-light fw-bolder" href="#">Contact</a>
            <a class="nav-link text-light fw-bolder" href="index.php?p=login">Log In</a>
          </div>
        </div>
      </div>
    </nav>
